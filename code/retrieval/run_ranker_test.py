...
class AntProcessor(DataProcessor):
    """Processor for the Ant data set (GLUE version)."""
...
class BuyProcessor(DataProcessor):
    """Processor for the Ant data set (GLUE version)."""

    def get_train_examples(self, data_dir):
        """See base class."""
        print('load {}'.format(data_dir).center(50, '-'))
        return self._create_examples(
...
class BuyMTProcessor(DataProcessor):
    """Processor for the Ant data set (GLUE version)."""
    ...
    def get_train_examples(self, data_dir):
        ...
        print('load {}'.format(data_dir).center(50, '-'))
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "train_buy.txt")), "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        print('load {}'.format(data_dir).center(50, '-'))
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "valid_buy.txt")), "dev")
...
class KeywordProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        ...
        print('load {}'.format(data_dir).center(50, '-'))
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "train_keyword.txt")), "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        print('load {}'.format(data_dir).center(50, '-'))
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, "valid_keyword.txt")), "dev")
...
class DoubanProcessor(DataProcessor):
    ...
    def _create_examples(self, lines, set_type):
        ...
        for (i, line) in enumerate(lines):
            ...
            if len(line) < 3:
                continue
            line = [l if i == 0 else ''.join(l.split()) for i, l in enumerate(line)]
...
class SingleSentProcessor(DataProcessor):
